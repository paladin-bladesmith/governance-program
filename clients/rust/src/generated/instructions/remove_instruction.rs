...
impl RemoveInstruction {
  pub fn instruction(&self, args: RemoveInstructionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RemoveInstructionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = RemoveInstructionInstructionData::new().try_to_vec().unwrap();
...
pub struct RemoveInstructionInstructionData {
            discriminator: u8,
            }
...
impl Default for RemoveInstructionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct RemoveInstructionInstructionArgs {
                  pub instruction_index: u32,
      }


/// Instruction builder for `RemoveInstruction`.
///
/// ### Accounts:
///
...
pub struct RemoveInstructionBuilder {
...
#[inline(always)]
    pub fn proposal(&mut self, proposal: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// Proposal transaction account
#[inline(always)]
    pub fn proposal_transaction(&mut self, proposal_transaction: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = RemoveInstruction {
                              stake_authority: self.stake_authority.expect("stake_authority is not set"),
                                        proposal: self.proposal.expect("proposal is not set"),
                                        proposal_transaction: self.proposal_transaction.expect("proposal_transaction is not set"),
                      };
          let args = RemoveInstructionInstructionArgs {
                                                              instruction_index: self.instruction_index.clone().expect("instruction_index is not set"),
                                    };
  ...
  /// `remove_instruction` CPI accounts.
  pub struct RemoveInstructionCpiAccounts<'a, 'b> {
                  /// Paladin stake authority account
...
/// `remove_instruction` CPI instruction.
pub struct RemoveInstructionCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: RemoveInstructionInstructionArgs,
  }

impl<'a, 'b> RemoveInstructionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: RemoveInstructionCpiAccounts<'a, 'b>,
              args: RemoveInstructionInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `RemoveInstruction` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` stake_authority
          ///   1. `[]` proposal
                ///   2. `[writable]` proposal_transaction
#[derive(Clone, Debug)]
pub struct RemoveInstructionCpiBuilder<'a, 'b> {
  instruction: Box<RemoveInstructionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveInstructionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RemoveInstructionCpiBuilderInstruction {
      __program: program,
...
#[inline(always)]
    pub fn proposal(&mut self, proposal: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Proposal transaction account
#[inline(always)]
    pub fn proposal_transaction(&mut self, proposal_transaction: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = RemoveInstructionInstructionArgs {
                                                              instruction_index: self.instruction.instruction_index.clone().expect("instruction_index is not set"),
                                    };
        let instruction = RemoveInstructionCpi {
        __program: self.instruction.__program,
          ...
          proposal_transaction: self.instruction.proposal_transaction.expect("proposal_transaction is not set"),
                          __args: args,
            };
...
#[derive(Clone, Debug)]
struct RemoveInstructionCpiBuilderInstruction<'a, 'b> {
