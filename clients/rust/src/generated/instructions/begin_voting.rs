...
impl BeginVoting {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = BeginVotingInstructionData::new().try_to_vec().unwrap();
...
pub struct BeginVotingInstructionData {
    discriminator: u8,
}

impl BeginVotingInstructionData {
    pub fn new() -> Self {
        Self { discriminator: 4 }
    }
}

impl Default for BeginVotingInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `BeginVoting`.
///
/// ### Accounts:
///
...
/// `begin_voting` CPI accounts.
pub struct BeginVotingCpiAccounts<'a, 'b> {
    /// Paladin stake authority account
...
/// `begin_voting` CPI instruction.
pub struct BeginVotingCpi<'a, 'b> {
...
impl<'a, 'b> BeginVotingCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: BeginVotingCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `BeginVoting` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` stake_authority
///   1. `[writable]` proposal
#[derive(Clone, Debug)]
pub struct BeginVotingCpiBuilder<'a, 'b> {
    instruction: Box<BeginVotingCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> BeginVotingCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(BeginVotingCpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = BeginVotingCpi {
...
#[derive(Clone, Debug)]
struct BeginVotingCpiBuilderInstruction<'a, 'b> {
