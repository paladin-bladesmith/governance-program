...
impl PushInstruction {
  pub fn instruction(&self, args: PushInstructionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: PushInstructionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    pub fn proposal_transaction(&mut self, proposal_transaction: solana_program::pubkey::Pubkey) -> &mut Self {
      ...
      pub fn instruction_program_id(&mut self, instruction_program_id: Pubkey) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn instruction_account_metas(&mut self, instruction_account_metas: Vec<ProposalAccountMeta>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = PushInstruction {
          ...
          let args = PushInstructionInstructionArgs {
                                                              instruction_program_id: self.instruction_program_id.clone().expect("instruction_program_id is not set"),
                                                                  instruction_account_metas: self.instruction_account_metas.clone().expect("instruction_account_metas is not set"),
                                                                  instruction_data: self.instruction_data.clone().expect("instruction_data is not set"),
                                    };
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = PushInstructionInstructionArgs {
                                                              instruction_program_id: self.instruction.instruction_program_id.clone().expect("instruction_program_id is not set"),
                                                                  instruction_account_metas: self.instruction.instruction_account_metas.clone().expect("instruction_account_metas is not set"),
                                                                  instruction_data: self.instruction.instruction_data.clone().expect("instruction_data is not set"),
                                    };
