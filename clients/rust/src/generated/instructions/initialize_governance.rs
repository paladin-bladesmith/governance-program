...
impl InitializeGovernance {
  pub fn instruction(&self, args: InitializeGovernanceInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeGovernanceInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = InitializeGovernanceInstructionData::new().try_to_vec().unwrap();
...
impl InitializeGovernanceBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            /// Governance config account
#[inline(always)]
    pub fn governance_config(&mut self, governance_config: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InitializeGovernance {
                              governance_config: self.governance_config.expect("governance_config is not set"),
          ...
          let args = InitializeGovernanceInstructionArgs {
                                                              cooldown_period_seconds: self.cooldown_period_seconds.clone().expect("cooldown_period_seconds is not set"),
                                                                  proposal_minimum_quorum: self.proposal_minimum_quorum.clone().expect("proposal_minimum_quorum is not set"),
                                                                  proposal_pass_threshold: self.proposal_pass_threshold.clone().expect("proposal_pass_threshold is not set"),
                                                                  voting_period_seconds: self.voting_period_seconds.clone().expect("voting_period_seconds is not set"),
                                                                  stake_per_proposal: self.stake_per_proposal.clone().expect("stake_per_proposal is not set"),
                                    };
...
impl<'a, 'b> InitializeGovernanceCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      /// Governance config account
#[inline(always)]
    pub fn governance_config(&mut self, governance_config: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InitializeGovernanceInstructionArgs {
                                                              cooldown_period_seconds: self.instruction.cooldown_period_seconds.clone().expect("cooldown_period_seconds is not set"),
                                                                  proposal_minimum_quorum: self.instruction.proposal_minimum_quorum.clone().expect("proposal_minimum_quorum is not set"),
                                                                  proposal_pass_threshold: self.instruction.proposal_pass_threshold.clone().expect("proposal_pass_threshold is not set"),
                                                                  voting_period_seconds: self.instruction.voting_period_seconds.clone().expect("voting_period_seconds is not set"),
                                                                  stake_per_proposal: self.instruction.stake_per_proposal.clone().expect("stake_per_proposal is not set"),
                                    };
        let instruction = InitializeGovernanceCpi {
        __program: self.instruction.__program,
                  
          governance_config: self.instruction.governance_config.expect("governance_config is not set"),
